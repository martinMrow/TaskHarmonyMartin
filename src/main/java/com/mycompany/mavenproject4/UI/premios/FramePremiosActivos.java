 ...
 * @author tetra
 */
public class FramePremiosActivos extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrameTareasActivas
     */
    public FramePremiosActivos(Usuario usuarioLogeado, UsuarioPerteneceFamilia upf) throws Exception {
        initComponents();
        ...
        this.setTitle("Task Harmony: Premios Activos");
    }
    ...
    private void initComponents() {
        ...
        BtnTareas.setToolTipText("Tareas disponibles para hacer");
        ...
        BtnCerrarSesion.setToolTipText("Cerrar esta sesión");
        ...
        TabPremiosActivos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Fecha", "Descripcion", "Tiempo restante"
            }
        ));
    ...
    private void updatePremiosActivosTable() throws Exception {
        ...
        String descripcion;
        List<UsuarioReclamaPremios> premiosActivos = servicio.findPremiosActivosPorUsuarioEnFamilia(usuarioLogeado.getDni(), idFamilia);
        ...
        for (UsuarioReclamaPremios premioActivo : premiosActivos) {
            ...
            descripcion = premioActivoSingular.getDescripcion();
            ...
            if (tiempoRestante.equalsIgnoreCase("caducado")) {
                ...
                model.addRow(new Object[]{nombreDelPremio, fecha, descripcion, tiempoRestante});
            }
        }
    }
