...
public class FrameTareasHechasPorFam extends javax.swing.JFrame {
    ...
    public FrameTareasHechasPorFam(UsuarioPerteneceFamilia upf, Usuario usuarioLogeado) {
        ...
        this.setTitle("Task Harmony: Tareas Realizadas por la familia");
    }
    ...
    private void initComponents() {
        ...
        BtnTareas.setToolTipText("Tareas por hacer");
        ...
        BtnTareasHechas.setToolTipText("Tareas hechas por tí");
    ...
    private void BtnPremiosTotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPremiosTotalActionPerformed
        ...
        nuevaVentana.setLocationRelativeTo(this); // Center relative to this window
    ...
    private void BtnPremiosActActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPremiosActActionPerformed
        try {
            FramePremiosActivos nuevaVentana = new FramePremiosActivos(usuarioLogeado, upf);
            nuevaVentana.setLocationRelativeTo(this); // Center relative to this window
            nuevaVentana.setVisible(true);
        } catch (Exception ex) {
    ...
    private void BtnCalificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCalificarActionPerformed
        ...
        String dni = model.getValueAt(selectedRow, 5).toString(); 
        String idTarea = model.getValueAt(selectedRow, 4).toString(); 
        Date fechaRealizada;
        try {
        ...
        FrameAdmUHT frameAdmUHT = new FrameAdmUHT(usuarioHaceTareas, this, idFamilia,idTarea);
        frameAdmUHT.setLocationRelativeTo(this); // Center relative to this window
