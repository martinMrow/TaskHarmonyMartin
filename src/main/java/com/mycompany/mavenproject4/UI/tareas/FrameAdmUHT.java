...
import com.mycompany.mavenproject4.UI.tareas.FrameTareasHechasPorFam;
...
public class FrameAdmUHT extends javax.swing.JFrame {
     ...
     */
    public FrameAdmUHT(UsuarioHaceTareas uht, FrameTareasHechasPorFam padre, int idFam, String idTarea) {
        initComponents();
        this.padre = padre;
        ...
        this.tareaSel = tareaSeleccionada(idTarea);
        this.txtPuntos.setText(String.valueOf(tareaSel.getPuntos()));
        setLocationRelativeTo(padre);  // Set location relative to parent
        try {
        ...
        this.setTitle("Task Harmony: Calificar tarea");
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Puntos (no pueden ser más de los establecidos):");
        ...
        BtnCancelar.setToolTipText("No calificar la tarea");
        ...
        BtnEditar.setToolTipText("Aplicar la calificacion ");
    ...
    private Tareas tareaSeleccionada(String idString) {
        return servicio.findTareaById(idTarea);
    }
    ...
    private void BtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditarActionPerformed
        ...
        if (tareaSel.getPuntos() < puntos) {
            JOptionPane.showMessageDialog(this, "No puedes asignar más puntos que los establecidos", "Error al actualizar la tarea: ", JOptionPane.ERROR_MESSAGE);
